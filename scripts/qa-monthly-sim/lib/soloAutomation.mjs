...
export function soloAutomationStatus(gameKey, result) {
  if (SOLO_EVENT_AUTOMATED.has(gameKey)) {
    if (result?.ok) return { status: "covered", reason: "automated_event_resolve" };
  ...
  if (/choice_required|invalid_session|not_implemented|pending_migration/i.test(msg)) {
