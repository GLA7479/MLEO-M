      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border-2 border-violet-700/45 bg-gradient-to-b from-zinc-900 to-zinc-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
        ...
        <div className="shrink-0 px-2.5 pb-0.5 pt-0 sm:px-3 sm:pb-1 lg:px-8">
          <div className="mb-0 flex items-center justify-between px-0.5 sm:mb-0.5">
            <span className="text-[8px] font-bold uppercase tracking-[0.16em] text-violet-200/40 sm:text-[9px]">Depth</span>
    ...
    <SoloV2GameShell
      ...
      helpContent={
        <div className="space-y-2">
          ...
          <p>
            After any safe row you may cash out to bank the secured payout, or keep digging toward row six for the crown
            multiplier. Gift rounds use freeplay — a loss does not debit your vault; a win credits the full payout.
          </p>
          <p>
