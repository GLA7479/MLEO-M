...
const TEXT = {
  ...
  ar: {
    ...
    arcadeWhat: "ما هو أركيد MLEO؟",
    arcadeWhatDesc: "أركيد MLEO مجموعة من 24 لعبة صغيرة مثيرة حيث يمكنك جمع مكافآت MLEO داخل التطبيق! كل لعبة لها آليات ومضاعفات فريدة.",
  ...
  es: {
    ...
    arcadeWhat: "¿Qué son los minijuegos MLEO?",
    arcadeWhatDesc: "Los minijuegos MLEO son una colección de 24 minijuegos donde puedes recolectar recompensas MLEO en la aplicación. Cada uno tiene mecánicas y multiplicadores únicos.",
    arcadeHowToPlay: "Cómo jugar",
    arcadeSteps: [
      "Elige cualquier minijuego de la selección",
    ...
    arcadeFreePlayList: [
      ...
      "Usa tokens para iniciar una sesión de minijuegos sin usar MLEO de la bóveda",
      "Las recompensas de sesiones de juego gratis se agregan a tu bóveda igual que las recompensas de sesión estándar"
    ],

    chooseGameLobbyShort: "Cuatro destinos, una bóveda compartida: mineros, MLEO Base, minijuegos y minijuegos en línea.",
    minersDescShort: "Idle y mejoras. Bóveda + reclamación on-chain.",
    poolStatus: "Pool",
    arcadeGames: "Minijuegos",
    arcadeOnline: "Minijuegos en línea",
    arcadeRegularTitle: "MLEO — Minijuegos",
    arcadeOnlineTitle: "MLEO — Minijuegos en línea",
    arcadeBadgeLabel: "Minijuegos",
    onlineBadgeLabel: "En línea",
    ...
    arcadeOnlineHowIntro: "Los modos en vivo y en línea de minijuegos usan la misma bóveda compartida y las mismas reglas del ecosistema que los minijuegos en solitario. El coste de sesión y las recompensas pueden variar según el modo.",
    legalShort: "Legal",
    howToPlayArcadeTitle: "Cómo jugar — Minijuegos",
    howToPlayArcadeOnlineTitle: "Cómo jugar — Minijuegos en línea",
    howToPlayMinersTitle: "Cómo jugar — Mineros",
    questHow: {
      ...
      featuresList: [
        ...
        "Este modo funciona con Mineros y minijuegos para progresión y utilidad a largo plazo.",
        "Construye con cabeza, mantén la estabilidad y fortalece tu base.",
      ],
    },
    baseTitle: "MLEO — Base",
    baseDesc: "Base de apoyo y gestión que conecta el modo mineros, los minijuegos y la bóveda compartida con misiones, datos, expediciones y mejoras estructurales.",
    ...
    baseHub: "Cuatro destinos, una bóveda compartida: mineros, MLEO Base, minijuegos en solitario y minijuegos en línea.",
    baseHubShort: "Cuatro destinos, una bóveda: mineros, Base, minijuegos y minijuegos en línea.",
  ...
  fr: {
    ...
    arcadeWhat: "Qu'est-ce que les mini-jeux MLEO ?",
    arcadeWhatDesc: "Les mini-jeux MLEO sont une collection de 24 mini-jeux où vous pouvez collecter des récompenses MLEO dans l'application. Chaque jeu a des mécaniques et multiplicateurs uniques.",
    arcadeHowToPlay: "Comment jouer",
    arcadeSteps: [
      "Choisissez n'importe quel mini-jeu dans la sélection",
    ...
    arcadeFreePlayList: [
      ...
      "Utilisez les tokens pour démarrer une session de mini-jeux sans utiliser MLEO du coffre",
      "Les récompenses des sessions de jeu gratuit sont ajoutées à votre coffre comme les récompenses de session standard"
    ],

    chooseGameLobbyShort: "Quatre destinations, un coffre-fort partagé : mineurs, MLEO Base, mini-jeux et mini-jeux en ligne.",
    minersDescShort: "Idle et améliorations. Coffre + réclamation on-chain.",
    poolStatus: "Pool",
    arcadeGames: "Mini-jeux",
    arcadeOnline: "Mini-jeux en ligne",
    arcadeRegularTitle: "MLEO — Mini-jeux",
    arcadeOnlineTitle: "MLEO — Mini-jeux en ligne",
    arcadeBadgeLabel: "Mini-jeux",
    ...
    arcadeOnlineHowIntro: "Les modes en direct et en ligne des mini-jeux partagent le même coffre et les mêmes règles d’écosystème que les mini-jeux solo. Coûts de session et récompenses peuvent varier selon le mode.",
    legalShort: "Infos légales",
    howToPlayArcadeTitle: "Comment jouer — Mini-jeux",
    howToPlayArcadeOnlineTitle: "Comment jouer — Mini-jeux en ligne",
    howToPlayMinersTitle: "Comment jouer — Mineurs",
    questHow: {
      ...
      featuresList: [
        ...
        "Ce mode s’aligne avec Mineurs et les mini-jeux pour une progression durable.",
        "Construisez intelligemment et renforcez votre base.",
      ],
    },
    baseTitle: "MLEO — Base",
    baseDesc: "Base de soutien et de gestion reliant les mineurs, les mini-jeux et le coffre partagé avec missions, données, expéditions et améliorations structurelles.",
    ...
    baseHub: "Quatre destinations, un coffre partagé : mineurs, MLEO Base, mini-jeux solo et mini-jeux en ligne.",
    baseHubShort: "Quatre destinations, un coffre : mineurs, Base, mini-jeux et mini-jeux en ligne.",
  ...
  de: {
    ...
    arcadeWhat: "Was sind die MLEO-Minispiele?",
    arcadeWhatDesc: "Die MLEO-Minispiele sind eine Sammlung von 24 spannenden Mini-Spielen, bei denen Sie MLEO-Belohnungen in der App sammeln können. Jedes Spiel hat einzigartige Mechaniken und Multiplikatoren.",
    arcadeHowToPlay: "Wie man spielt",
    arcadeSteps: [
      "Wählen Sie ein beliebiges Spiel aus den Minispielen",
    ...
    arcadeFreePlayList: [
      ...
      "Verwenden Sie Token, um eine Minispiel-Sitzung zu starten, ohne MLEO aus dem Tresor zu verwenden",
      "Belohnungen aus kostenlosen Spielsitzungen werden zu Ihrem Tresor hinzugefügt, genau wie Standard-Sitzungsbelohnungen"
    ],

    chooseGameLobbyShort: "Vier Ziele, ein gemeinsamer Vault: Miner, MLEO-Basis, Minispiele und Online-Minispiele.",
    minersDescShort: "Idle & Upgrades. Vault + On-Chain-Claim.",
    poolStatus: "Pool",
    arcadeGames: "Minispiele",
    arcadeOnline: "Online-Minispiele",
    arcadeRegularTitle: "MLEO — Minispiele",
    arcadeOnlineTitle: "MLEO — Online-Minispiele",
    arcadeBadgeLabel: "Minispiele",
    onlineBadgeLabel: "Online",
    ...
    arcadeOnlineHowIntro: "Live- und Online-Modi der Minispiele nutzen denselben geteilten Vault und dieselben Ökosystemregeln wie die Einzelspieler-Minispiele. Sitzungskosten und Belohnungen können je nach Modus variieren.",
    legalShort: "Rechtliches",
    howToPlayArcadeTitle: "Spielanleitung — Minispiele",
    howToPlayArcadeOnlineTitle: "Spielanleitung — Online-Minispiele",
    howToPlayMinersTitle: "Spielanleitung — Miner",
    questHow: {
      ...
      featuresList: [
        ...
        "Dieser Modus ergänzt Miner und Minispiele (Einzel- und Online-) für langfristige Progression.",
        "Klug bauen, Stabilität halten, Basis stärken.",
      ],
    },
    baseTitle: "MLEO — Basis",
    baseDesc: "Eine Unterstützungs- und Management-Basis, die Miner, Minispiele und den gemeinsamen Vault mit Missionen, Daten, Expeditionen und strukturellen Verbesserungen verbindet.",
    ...
    baseHub: "Vier Ziele, ein geteilter Vault: Miner, MLEO-Basis, Minispiele und Online-Minispiele.",
    baseHubShort: "Vier Ziele, ein Vault: Miner, Basis, Minispiele und Online-Minispiele.",
  ...
  ja: {
    ...
    arcadeWhat: "MLEOアーケードとは？",
    arcadeWhatDesc: "MLEOアーケードは、アプリ内でMLEO報酬を集められる24種類のミニゲームのコレクションです。各ゲームは独自のメカニクスと倍率があります。",
  ...
  ko: {
    ...
    arcadeWhat: "MLEO 아케이드란?",
    arcadeWhatDesc: "MLEO 아케이드는 앱 안에서 MLEO 보상을 모을 수 있는 24개의 미니 게임 모음입니다. 각 게임은 고유한 메커니즘과 배율이 있습니다.",
  ...
  tr: {
    ...
    arcadeWhat: "MLEO oyun salonu nedir?",
    arcadeWhatDesc: "MLEO oyun salonu, uygulama içi MLEO ödüllerini toplayabileceğiniz 24 heyecan verici mini oyun koleksiyonudur! Her oyunun benzersiz mekanikleri ve çarpanları vardır.",
    arcadeHowToPlay: "Nasıl oynanır",
    arcadeSteps: [
      "Oyun salonundan herhangi bir oyun seçin",
    ...
    arcadeFreePlayList: [
      ...
      "Kasası MLEO kullanmadan bir oyun salonu oturumu başlatmak için jetonları kullanın",
      "Ücretsiz oyun oturumlarından gelen ödüller, standart oturum ödülleri gibi kasasına eklenir"
    ],

    chooseGameLobbyShort: "Dört hedef, bir paylaşımlı kasa: madenciler, MLEO Üssü, oyun salonu ve çevrimiçi oyun salonu.",
    minersDescShort: "Idle ve yükseltmeler. Kasa + zincir üstü talep.",
    poolStatus: "Havuz",
    arcadeGames: "Oyun salonu",
    arcadeOnline: "Çevrimiçi oyun salonu",
    arcadeRegularTitle: "MLEO — Oyun salonu",
    arcadeOnlineTitle: "MLEO — Çevrimiçi oyun salonu",
    arcadeBadgeLabel: "Salon",
    ...
    arcadeOnlineHowIntro: "Canlı ve çevrimiçi oyun salonu modları, tek oyunculu oyun salonu ile aynı paylaşımlı kasa ve ekosistem kurallarını kullanır. Oturum maliyetleri ve ödüller moda göre değişebilir.",
    legalShort: "Yasal",
    howToPlayArcadeTitle: "Nasıl oynanır — Oyun salonu",
    howToPlayArcadeOnlineTitle: "Nasıl oynanır — Çevrimiçi oyun salonu",
    howToPlayMinersTitle: "Nasıl oynanır — Madenciler",
    questHow: {
      ...
      featuresList: [
        ...
        "Bu mod madenciler ve oyun salonu ile uzun vadeli ilerlemeyi destekler.",
        "Akıllıca inşa edin, istikrarı koruyun, üssünüzü güçlendirin.",
      ],
    },
    baseTitle: "MLEO — Üs",
    baseDesc: "Görevler, veri, seferler ve yapısal yükseltmelerle madencileri, oyun salonunu ve paylaşımlı kasayı birleştiren destek ve yönetim üssü.",
    baseDescShort: "Destek merkezi: paylaşımlı kasa için görevler, veri ve seferler.",
    baseBadgeLabel: "Destek",
    playBase: "MLEO Üssü Oyna",
    baseHub: "Dört hedef, bir paylaşımlı kasa: madenciler, MLEO Üssü, tek oyunculu oyun salonu ve çevrimiçi oyun salonu.",
    baseHubShort: "Dört hedef, bir kasa: madenciler, Üs, oyun salonu ve çevrimiçi oyun salonu.",
  ...
  it: {
    ...
    arcadeWhat: "Cosa sono i minigiochi MLEO?",
    arcadeWhatDesc: "I minigiochi MLEO sono una collezione di 24 mini-giochi in cui puoi raccogliere ricompense MLEO nell'app. Ogni gioco ha meccaniche e moltiplicatori unici.",
    arcadeHowToPlay: "Come giocare",
    arcadeSteps: [
      "Scegli qualsiasi mini-gioco dall'elenco",
    ...
    arcadeFreePlayList: [
      ...
      "Usa i token per avviare una sessione di minigiochi senza usare MLEO dal caveau",
    ...
    chooseGameLobbyShort: "Quattro destinazioni, un vault condiviso: minatori, MLEO Base, minigiochi e minigiochi online.",
    minersDescShort: "Idle e potenziamenti. Vault + claim on-chain.",
    poolStatus: "Pool",
    arcadeGames: "Minigiochi",
    arcadeOnline: "Minigiochi online",
    arcadeRegularTitle: "MLEO — Minigiochi",
    arcadeOnlineTitle: "MLEO — Minigiochi online",
    arcadeBadgeLabel: "Minigiochi",
    onlineBadgeLabel: "Online",
    ...
    arcadeOnlineHowIntro: "Le modalità dal vivo e online dei minigiochi usano lo stesso vault condiviso e le stesse regole dell’ecosistema dei minigiochi in solitaria. Costi di sessione e ricompense possono variare.",
    legalShort: "Note legali",
    howToPlayArcadeTitle: "Come giocare — Minigiochi",
    howToPlayArcadeOnlineTitle: "Come giocare — Minigiochi online",
    howToPlayMinersTitle: "Come giocare — Minatori",
    questHow: {
      ...
      featuresList: [
        ...
        "Questa modalità lavora con Minatori e minigiochi per la progressione.",
        "Costruisci con intelligenza e rafforza la base.",
      ],
    },
    baseTitle: "MLEO — Base",
    baseDesc: "Base di supporto e gestione che collega minatori, minigiochi e il vault condiviso con missioni, dati, spedizioni e miglioramenti strutturali.",
    ...
    baseHub: "Quattro destinazioni, un vault condiviso: minatori, MLEO Base, minigiochi in solitaria e minigiochi online.",
    baseHubShort: "Quattro destinazioni, un vault: minatori, Base, minigiochi e minigiochi online.",
  ...
  ka: {
    ...
    arcadeWhat: "რა არის MLEO არკადა?",
    arcadeWhatDesc: "MLEO არკადა არის 24 საინტერესო მინი-თამაშების კოლექცია, სადაც შეგიძლიათ შეაგროვოთ აპლიკაციაში MLEO ჯილდოები. თითოეულ თამაშს აქვს უნიკალური მექანიკა და მულტიპლიკატორი.",
    ...
    questHow: {
      ...
      featuresList: [
        ...
        "ეს რეჟიმი მაინერებსა და არკადას უხსნის გრძელვადიან პროგრესს.",
  ...
  pl: {
    ...
    arcadeWhat: "Czym są gry arkadowe MLEO?",
    arcadeWhatDesc: "Gry arkadowe MLEO to kolekcja 24 ekscytujących mini-gier, w których możesz zbierać nagrody MLEO w aplikacji. Każda gra ma unikalną mechanikę i mnożniki.",
    arcadeHowToPlay: "Jak grać",
    arcadeSteps: [
      "Wybierz dowolną grę spośród gier arkadowych MLEO",
    ...
    arcadeFreePlayList: [
      ...
      "Używaj tokenów, aby rozpocząć sesję gier arkadowych bez używania MLEO ze skarbca",
      "Nagrody z darmowych sesji gry są dodawane do twojego skarbca tak samo jak standardowe nagrody sesji"
    ],

    chooseGameLobbyShort: "Cztery miejsca docelowe, jeden wspólny skarbiec: górnicy, MLEO Baza, gry arkadowe i gry arkadowe online.",
    minersDescShort: "Idle i ulepszenia. Skarbiec + odbiór on-chain.",
    poolStatus: "Pula",
    arcadeGames: "Gry arkadowe",
    arcadeOnline: "Gry arkadowe online",
    arcadeRegularTitle: "MLEO — Gry arkadowe",
    arcadeOnlineTitle: "MLEO — Gry arkadowe online",
    arcadeBadgeLabel: "Arkada",
    onlineBadgeLabel: "Online",
    ...
    arcadeOnlineHowIntro: "Tryby gier arkadowych na żywo i online korzystają z tego samego wspólnego skarbca i zasad co solo gry arkadowe. Koszty sesji i nagrody mogą się różnić.",
    legalShort: "Informacje prawne",
    howToPlayArcadeTitle: "Jak grać — Gry arkadowe",
    howToPlayArcadeOnlineTitle: "Jak grać — Gry arkadowe online",
    howToPlayMinersTitle: "Jak grać — Górnicy",
    questHow: {
      ...
      featuresList: [
        ...
        "Tryb współpracuje z górnikami i grami arkadowymi w długiej grze.",
        "Buduj mądrze, utrzymuj stabilność, wzmacniaj bazę.",
      ],
    },
    baseTitle: "MLEO — Baza",
    baseDesc: "Baza wsparcia i zarządzania łącząca tryb górników, gry arkadowe i wspólny skarbiec misjami, danymi, ekspedycjami i ulepszeniami strukturalnymi.",
    ...
    baseHub: "Cztery miejsca, jeden wspólny skarbiec: górnicy, MLEO Baza, solo gry arkadowe i gry arkadowe online.",
    baseHubShort: "Cztery miejsca, jeden skarbiec: górnicy, Baza, gry arkadowe i gry arkadowe online.",
  ...
  ro: {
    ...
    arcadeWhat: "Ce sunt mini-jocurile MLEO?",
    arcadeWhatDesc: "Mini-jocurile MLEO sunt o colecție de 24 de mini-jocuri în care poți colecta recompense MLEO în aplicație. Fiecare joc are mecanici și multiplicatori unici.",
    arcadeHowToPlay: "Cum să joci",
    arcadeSteps: [
      "Alege orice mini-joc din selecție",
    ...
    arcadeFreePlayList: [
      ...
      "Folosește tokenurile pentru a începe o sesiune de mini-jocuri fără a folosi MLEO din seif",
      "Recompensele din sesiunile de joc gratuit sunt adăugate în seiful tău la fel ca recompensele standard de sesiune"
    ],

    chooseGameLobbyShort: "Patru destinații, un seif partajat: mineri, MLEO Bază, mini-jocuri și mini-jocuri online.",
    minersDescShort: "Idle și upgrade-uri. Seif + claim on-chain.",
    poolStatus: "Pool",
    arcadeGames: "Mini-jocuri",
    arcadeOnline: "Mini-jocuri online",
    arcadeRegularTitle: "MLEO — Mini-jocuri",
    arcadeOnlineTitle: "MLEO — Mini-jocuri online",
    arcadeBadgeLabel: "Mini-jocuri",
    onlineBadgeLabel: "Online",
    ...
    arcadeOnlineHowIntro: "Modurile live și online ale mini-jocurilor folosesc același seif partajat și aceleași reguli ca mini-jocurile solo. Costurile și recompensele pot diferi.",
    legalShort: "Legal",
    howToPlayArcadeTitle: "Cum se joacă — Mini-jocuri",
    howToPlayArcadeOnlineTitle: "Cum se joacă — Mini-jocuri online",
    howToPlayMinersTitle: "Cum se joacă — Mineri",
    questHow: {
      ...
      featuresList: [
        ...
        "Modul lucrează cu minerii și mini-jocurile pentru progres.",
        "Construiește inteligent și întărește baza.",
      ],
    },
    baseTitle: "MLEO — Bază",
    baseDesc: "Bază de suport și management care leagă minerii, mini-jocurile și seiful partajat prin misiuni, date, expediții și îmbunătățiri structurale.",
    ...
    baseHub: "Patru destinații, un seif partajat: mineri, MLEO Bază, mini-jocuri solo și mini-jocuri online.",
    baseHubShort: "Patru destinații, un seif: mineri, Bază, mini-jocuri și mini-jocuri online.",
  ...
  cs: {
    ...
    arcadeWhat: "Co je MLEO Arkáda?",
    arcadeWhatDesc: "MLEO Arkáda je sbírka 24 vzrušujících miniher, kde můžete sbírat odměny MLEO v aplikaci. Každá hra má jedinečné mechaniky a multiplikátory.",
    arcadeHowToPlay: "Jak hrát",
    arcadeSteps: [
      "Vyberte libovolnou hru z arkády",
    ...
    chooseGameLobbyShort: "Čtyři cíle, jeden sdílený trezor: horníci, MLEO Základna, arkáda a arkáda online.",
    minersDescShort: "Idle a vylepšení. Trezor + on-chain claim.",
    poolStatus: "Pool",
    arcadeGames: "Arkáda",
    arcadeOnline: "Arkáda online",
    arcadeRegularTitle: "MLEO — Arkáda",
    arcadeOnlineTitle: "MLEO — Arkáda online",
    arcadeBadgeLabel: "Arkáda",
    onlineBadgeLabel: "Online",
    ...
    arcadeOnlineHowIntro: "Živé a online módy arkády používají stejný sdílený trezor a pravidla jako sólová arkáda. Náklady a odměny se mohou lišit.",
    legalShort: "Právní info",
    howToPlayArcadeTitle: "Jak hrát — Arkáda",
    howToPlayArcadeOnlineTitle: "Jak hrát — Arkáda online",
    howToPlayMinersTitle: "Jak hrát — Horníci",
    questHow: {
      ...
      featuresList: [
        ...
        "Režim doplňuje horníky a arkádu pro dlouhodobou hru.",
        "Stavte chytře a posilujte základnu.",
      ],
    },
    baseTitle: "MLEO — Základna",
    baseDesc: "Základna podpory a řízení propojující režim horníků, arkádu a sdílený trezor misemi, daty, expediciemi a strukturálními vylepšeními.",
    baseDescShort: "Centrum podpory: mise, data a expedice pro sdílený trezor.",
    baseBadgeLabel: "Podpora",
    playBase: "Hrát MLEO Základna",
    baseHub: "Čtyři cíle, jeden sdílený trezor: horníci, MLEO Základna, sólová arkáda a arkáda online.",
    baseHubShort: "Čtyři cíle, jeden trezor: horníci, Základna, arkáda a arkáda online.",
  ...
  nl: {
    ...
    arcadeWhat: "Wat is de MLEO-speelhal?",
    arcadeWhatDesc: "De MLEO-speelhal is een verzameling van 24 spannende minigames waarin je MLEO-beloningen in de app kunt verzamelen. Elke game heeft unieke mechanica en vermenigvuldigers.",
    arcadeHowToPlay: "Hoe te spelen",
    arcadeSteps: [
      "Kies een willekeurige game uit de MLEO-speelhal",
    ...
    arcadeFreePlayList: [
      ...
      "Gebruik tokens om een speelhalsessie te starten zonder kluis-MLEO te gebruiken",
      "Beloningen van gratis spelsessies worden toegevoegd aan je kluis, net als standaard sessiebeloningen"
    ],

    chooseGameLobbyShort: "Vier bestemmingen, één gedeelde kluis: mijnwerkers, MLEO-basis, speelhal en online speelhal.",
    minersDescShort: "Idle & upgrades. Kluis + on-chain claim.",
    poolStatus: "Pool",
    arcadeGames: "Speelhal",
    arcadeOnline: "Online speelhal",
    arcadeRegularTitle: "MLEO — Speelhal",
    arcadeOnlineTitle: "MLEO — Online speelhal",
    arcadeBadgeLabel: "Speelhal",
    onlineBadgeLabel: "Online",
    ...
    arcadeOnlineHowIntro: "Live- en onlinespeelhalmodi gebruiken dezelfde gedeelde kluis en ecosysteemregels als solo speelhal. Sessiekosten en beloningen kunnen verschillen.",
    legalShort: "Juridisch",
    howToPlayArcadeTitle: "Hoe te spelen — Speelhal",
    howToPlayArcadeOnlineTitle: "Hoe te spelen — Online speelhal",
    howToPlayMinersTitle: "Hoe te spelen — Mijnwerkers",
    questHow: {
      ...
      featuresList: [
        ...
        "Modus werkt samen met Mijnwerkers en speelhal.",
        "Slim bouwen en basis versterken.",
      ],
    },
    baseTitle: "MLEO — basis",
    baseDesc: "Een ondersteunings- en managementbasis die mijnwerkers, speelhal en de gedeelde kluis verbindt met missies, data, expedities en structurele verbeteringen.",
    ...
    baseHub: "Vier bestemmingen, één gedeelde kluis: mijnwerkers, MLEO-basis, solo speelhal en online speelhal.",
    baseHubShort: "Vier bestemmingen, één kluis: mijnwerkers, basis, speelhal en online speelhal.",
  ...
  el: {
    ...
    arcadeWhat: "Τι είναι το MLEO Αρκέιντ;",
    arcadeWhatDesc: "Το MLEO Αρκέιντ είναι μια συλλογή 24 συναρπαστικών μίνι παιχνιδιών όπου μπορείτε να συλλέξετε ανταμοιβές MLEO στην εφαρμογή. Κάθε παιχνίδι έχει μοναδικές μηχανικές και πολλαπλασιαστές.",
    arcadeHowToPlay: "Πώς να παίξετε",
    arcadeSteps: [
      "Επιλέξτε οποιοδήποτε παιχνίδι από το αρκέιντ",
    ...
    arcadeFreePlay: "Δωρεάν μάρκες παιχνιδιού",
    arcadeFreePlayList: [
      "Λάβετε 1 δωρεάν μάρκα παιχνιδιού κάθε ώρα (έως 5 αποθηκευμένα)",
      "Χρησιμοποιήστε μάρκες για να ξεκινήσετε μια συνεδρία αρκέιντ χωρίς να χρησιμοποιήσετε MLEO από το χρηματοκιβώτιο",
    ...
    chooseGameLobbyShort: "Τέσσερις προορισμοί, ένα κοινό χρηματοκιβώτιο: εξορυκτές, MLEO Βάση, αρκέιντ και αρκέιντ online.",
    minersDescShort: "Idle και αναβαθμίσεις. Vault + on-chain claim.",
    poolStatus: "Pool",
    arcadeGames: "Αρκέιντ",
    arcadeOnline: "Αρκέιντ online",
    arcadeRegularTitle: "MLEO — Αρκέιντ",
    arcadeOnlineTitle: "MLEO — Αρκέιντ online",
    arcadeBadgeLabel: "Αρκέιντ",
    onlineBadgeLabel: "Online",
    ...
    arcadeOnlineHowIntro: "Τα live και online modes αρκέιντ χρησιμοποιούν το ίδιο κοινό vault και κανόνες με το solo αρκέιντ. Κόστος session και ανταμοιβές μπορεί να διαφέρουν.",
    legalShort: "Νομικά",
    howToPlayArcadeTitle: "Πώς να παίξεις — Αρκέιντ",
    howToPlayArcadeOnlineTitle: "Πώς να παίξεις — Αρκέιντ online",
    howToPlayMinersTitle: "Πώς να παίξεις — Εξορυκτές",
    questHow: {
      ...
      featuresList: [
        ...
        "Λειτουργεί με εξορυκτές και αρκέιντ για μακροπρόθεσμη πρόοδο.",
        "Χτίσε έξυπνα και ενίσχυσε τη βάση.",
      ],
    },
    baseTitle: "MLEO — Βάση",
    baseDesc: "Βάση υποστήριξης και διαχείρισης που συνδέει εξορυκτές, αρκέιντ και το κοινό χρηματοκιβώτιο με αποστολές, δεδομένα, εκστρατείες και δομικές αναβαθμίσεις.",
  ...
  he: {
    ...
    arcadeWhat: "מהו ארקייד MLEO?",
    arcadeWhatDesc: "ארקייד MLEO הוא אוסף של 24 מיני-משחקים שבהם אפשר לאסוף פרסי MLEO בתוך האפליקציה. לכל משחק יש מכניקות ומכפילים ייחודיים.",
    ...
    questHow: {
      ...
      featuresList: [
        "המוד הזה עובד יחד עם כורים וארקייד כדי לתמוך בהתקדמות ארוכת טווח, utility חכם ואיזון טוקן בריא.",
