...
export default async function handler(req, res) {
  ...
  try {
    ...
    const rateLimit = await checkArcadeRateLimit("solo-v2-pulse-lock-vault-delta", deviceId, 30, 60_000);
    ...
    const rawGameId = String(req.body?.gameId || "solo-v2-pulse-lock-settlement");
    const gameId = sanitizeGameId(rawGameId) || "solo-v2-pulse-lock-settlement";
    ...
    console.error("solo-v2/pulse-lock/vault-delta failed", error);
