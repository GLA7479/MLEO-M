/**
 * OV2 FourLine settlement claim RPC + vault apply bridge.
 */
 ...
 */
export async function requestOv2FourLineClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_fourline_claim_settlement", {
      p_room_id: rid,
