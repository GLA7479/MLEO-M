/**
 * OV2 Goal Duel — settlement claim RPC.
 */
 ...
 */
export async function requestOv2GoalDuelClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_goal_duel_claim_settlement", {
      p_room_id: rid,
