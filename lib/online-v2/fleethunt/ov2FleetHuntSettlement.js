/**
 * OV2 Fleet Hunt — settlement claim RPC.
 */
 ...
 */
export async function requestOv2FleetHuntClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_fleet_hunt_claim_settlement", {
      p_room_id: rid,
