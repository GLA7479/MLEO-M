 ...
 * Uses `ov2LudoEngine` rules. Authoritative play will apply dice/moves only via server RPC + snapshot (`ov2LudoSessionAdapter`);
 * do not call this module from a `LIVE_MATCH_ACTIVE` path.
 */
