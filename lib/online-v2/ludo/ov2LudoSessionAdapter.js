...
/**
 * SQL drafts: `015_ov2_ludo_schema.sql`, `016_ov2_ludo_rpcs.sql`, `017_ov2_ludo_realtime.sql`.
 * Remaining product gaps: host UI to call `requestOv2LudoOpenSession`, room finalize/settlement hooks when `phase = finished`.
 */
