/**
 * OV2 Color Clash — settlement claim RPC.
 */
 ...
 */
export async function requestOv2ColorClashClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_colorclash_claim_settlement", {
      p_room_id: rid,
