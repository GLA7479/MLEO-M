/**
 * OV2 Dominoes settlement claim RPC + vault apply bridge.
 */
 ...
 */
export async function requestOv2DominoesClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_dominoes_claim_settlement", {
      p_room_id: rid,
