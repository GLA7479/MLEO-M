 ...
 * 9. **Desktop (`dk`) only** — presentation remaps (labels still `seatIndex + 1`): **n=2** — swap **0↔1**; **n=3** — cycle mod 3; **n=4** — cycle **0→1→2→3→0**; **n≥5** — compose swap **4↔5** (server **3** and **4**): first five slots cycle **0→1→2→3→4→0**; seats **6+** unchanged. Tablet (`pad`) and mobile unchanged.
 ...
 * Composed UI swaps (1↔2 … 4↔5): n=2 → mod 2; n=3 → mod 3; n=4 → mod 4 on 0–3; n≥5 → mod 5 on 0–4.
