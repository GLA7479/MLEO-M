/**
 * OV2 Snakes & Ladders — settlement claim RPC.
 */
 ...
 */
export async function requestOv2SnakesClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_snakes_claim_settlement", {
      p_room_id: rid,
