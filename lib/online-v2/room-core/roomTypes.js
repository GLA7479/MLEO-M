...
export const OV2_SHARED_ROOM_PUBLIC_FIELDS =
  "id,created_at,updated_at,product_game_id,title,status,visibility_mode,join_code,min_players,max_players,host_member_id,created_by_participant_key,active_runtime_id,room_revision,last_activity_at,is_hard_closed,hard_closed_at,hard_close_reason,started_at,ended_at,shared_schema_version";
