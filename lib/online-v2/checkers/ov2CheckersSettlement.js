/**
 * OV2 Checkers settlement claim RPC + vault apply bridge.
 */
 ...
 */
export async function requestOv2CheckersClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_checkers_claim_settlement", {
      p_room_id: rid,
