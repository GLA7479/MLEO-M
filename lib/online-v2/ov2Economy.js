...
export const ONLINE_V2_GAME_KINDS = Object.freeze({
  ...
  /** Shared-room table — Snakes & Ladders (2–4 seats). */
  SNAKES_AND_LADDERS: "ov2_snakes_and_ladders",
  /** Shared-room 1v1 artillery duel — Tanks V1. */
  TANKS: "ov2_tanks",
  ...
  /** Shared-room 2–4 board — Orbit Trap. */
  ORBIT_TRAP: "ov2_orbit_trap",
});
