...
/** 1v1 ping-pong double-enabled OV2 products: full liability locked at stake commit (16× stake_per_seat). */
const OV2_DOUBLE_MAX_LIABILITY_PRODUCT_IDS = new Set([
  ONLINE_V2_GAME_KINDS.FOURLINE,
  ONLINE_V2_GAME_KINDS.FLIPGRID,
  ONLINE_V2_GAME_KINDS.FLEET_HUNT,
  ONLINE_V2_GAME_KINDS.DOMINOES,
...
export function getOv2MaxRoundLiabilityMult(productGameId) {
  ...
  return OV2_DOUBLE_MAX_LIABILITY_PRODUCT_IDS.has(id) ? OV2_MAX_ROUND_LIABILITY_MULT : 1;
}
