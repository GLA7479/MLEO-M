...
/**
 * Post-finish rematch slice for live Board Path (Phase 4).
 * @param {Ov2BoardPathContext|null|undefined} rawContext
 * @param {string|null|undefined} hostKey
 * @param {{ rematchBusy?: boolean, rematchError?: { code?: string, message?: string }|null }} [hookFlags]
 */
export function buildBoardPathPostFinishSlice(rawContext, hostKey, hookFlags) {
  ...
  const busy = Boolean(hookFlags?.rematchBusy);
