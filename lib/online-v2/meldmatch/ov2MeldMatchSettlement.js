/**
 * OV2 MeldMatch settlement claim RPC + vault apply bridge.
 */
 ...
 */
export async function requestOv2MeldMatchClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_meldmatch_claim_settlement", {
      p_room_id: rid,
