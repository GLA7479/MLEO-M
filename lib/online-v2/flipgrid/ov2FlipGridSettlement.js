/**
 * OV2 FlipGrid settlement claim RPC + vault apply bridge.
 */
 ...
 */
export async function requestOv2FlipGridClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_flipgrid_claim_settlement", {
      p_room_id: rid,
