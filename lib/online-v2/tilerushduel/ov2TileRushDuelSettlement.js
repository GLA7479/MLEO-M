/**
 * OV2 Tile Rush Duel — settlement claim RPC.
 */
 ...
 */
export async function requestOv2TileRushDuelClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_tile_rush_duel_claim_settlement", {
      p_room_id: rid,
