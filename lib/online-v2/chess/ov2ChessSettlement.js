/**
 * OV2 Chess settlement claim RPC + vault apply bridge.
 */
 ...
 */
export async function requestOv2ChessClaimSettlement(roomId, participantKey) {
  ...
  try {
    const { data, error } = await supabaseMP.rpc("ov2_chess_claim_settlement", {
      p_room_id: rid,
