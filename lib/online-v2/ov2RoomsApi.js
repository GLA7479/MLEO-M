...
export const OV2_ROOM_PUBLIC_FIELDS =
  "id,created_at,updated_at,product_game_id,title,lifecycle_phase,stake_per_seat,host_participant_key,is_private,max_seats,match_seq,pot_locked,active_session_id,closed_reason,meta";
...
/**
 * Records stake commit server-side (economy row + member wallet_state). Call `debitOnlineV2Vault` after success.
