...
const RECEIPT_PREFIX_SURGE_CASHOUT = "solo_v2_surge_cashout_settlement_receipt:";
const RECEIPT_PREFIX_RAIL_LOGIC = "solo_v2_rail_logic_settlement_receipt:";
const RECEIPT_PREFIX_SHADOW_TELL = "solo_v2_shadow_tell_settlement_receipt:";
const RECEIPT_PREFIX_CORE_BALANCE = "solo_v2_core_balance_settlement_receipt:";
const RECEIPT_PREFIX_RELIC_DRAFT = "solo_v2_relic_draft_settlement_receipt:";
...
export async function applySurgeCashoutSettlementOnce(sessionId, settlementSummary) {
  return applySharedVaultSettlementOnce(sessionId, settlementSummary, RECEIPT_PREFIX_SURGE_CASHOUT);
}

export async function applyRailLogicSettlementOnce(sessionId, settlementSummary) {
  return applySharedVaultSettlementOnce(sessionId, settlementSummary, RECEIPT_PREFIX_RAIL_LOGIC);
}

export async function applyShadowTellSettlementOnce(sessionId, settlementSummary) {
  return applySharedVaultSettlementOnce(sessionId, settlementSummary, RECEIPT_PREFIX_SHADOW_TELL);
}

export async function applyCoreBalanceSettlementOnce(sessionId, settlementSummary) {
  return applySharedVaultSettlementOnce(sessionId, settlementSummary, RECEIPT_PREFIX_CORE_BALANCE);
}

export async function applyRelicDraftSettlementOnce(sessionId, settlementSummary) {
  return applySharedVaultSettlementOnce(sessionId, settlementSummary, RECEIPT_PREFIX_RELIC_DRAFT);
}
