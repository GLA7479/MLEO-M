...
/** Landing columns across the bottom row (server + canvas); must stay 1:1. */
export const DROP_RUN_GATES = 9;
/** Independent random drifts per drop; pathPositions length === this + 1. */
export const DROP_RUN_DRIFT_ROWS = 15;
...
/** Visible peg rows on the Drop Run canvas (geometry only; server uses DROP_RUN_DRIFT_ROWS for path). */
export const DROP_RUN_PEG_ROWS = 15;
/**
