...
/**
 * @returns {number[]} length = chamber count, values 0..sigilCount-1 (each index independent).
 * Uses Node crypto.randomInt(min, max) where max is exclusive → uniform over [0, SIGIL_COUNT).
 */
