 ...
 * after successful operate commits; pre-check on sit blocks second-table entry.
 */
...
/**
 * Block private create/join when the participant already holds an active fixed-table seat,
 * except when `allowOnlyRoomId` matches the registry row (same room — e.g. re-verify).
 * @param {import("@supabase/supabase-js").SupabaseClient} admin
