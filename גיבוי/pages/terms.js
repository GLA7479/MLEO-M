...
// Import the Terms component from mining.js
...
export default function TermsPage() {
  ...
  return (
    <Layout title="Terms & Conditions — MLEO">
      <Head>
        <meta name="description" content="MLEO Terms & Conditions - Platform usage terms and legal agreements" />
      </Head>
      ...
      >
        <div className="prose prose-invert max-w-none">
          ...
          <div className="bg-white text-black rounded-lg p-6 md:p-8">
            <TermsContent />
          </div>
