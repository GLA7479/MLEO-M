-- Canonical shared OV2 integration for Snakes & Ladders (economy policy, QM allowlist, leave-room forfeit dispatch).
-- Apply after snakes-and-ladders/155_ov2_snakes_settlement.sql (Snakes primitives must exist).
-- Neutral placement: migrations/online-v2/ root (not under snakes-and-ladders/).
