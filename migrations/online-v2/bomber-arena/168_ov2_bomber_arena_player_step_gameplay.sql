-- OV2 Bomber Arena — player_step (gameplay): breakables block movement; blast stops at breakables; fuse default coalesce.
-- Apply after 167_ov2_bomber_arena_initial_board_gameplay.sql.
...
BEGIN
  ...
  v_fuse0 := greatest(coalesce((v_board ->> 'fuseTicksDefault')::int, 5), 1);
