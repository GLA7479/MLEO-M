-- Wire OV2 FourLine into shared-room economy, Quick Match allowlist, and leave/forfeit.
-- Apply after 105_ov2_fourline_rpcs_actions.sql.
-- Extends prior shared integration: add ov2_fourline to policy lists + active-match detection + forfeit.
...
BEGIN
  ...
  IF v_room.status = 'IN_GAME' THEN
    ...
    IF v_in_ludo_match OR v_in_r51_match OR v_in_bg_match OR v_in_ck_match OR v_in_ch_match OR v_in_dom_match OR v_in_fl_match THEN
