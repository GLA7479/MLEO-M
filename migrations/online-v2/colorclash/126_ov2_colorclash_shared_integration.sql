-- Wire OV2 Color Clash into shared-room economy, Quick Match allowlist, max players, and leave/forfeit.
-- Apply after 125_ov2_colorclash_rpcs_actions.sql (and after any migration that last replaced ov2_shared_leave_room).
-- Merges Color Clash into the integration surface from 121_ov2_meldmatch_shared_integration.sql.
...
BEGIN
  ...
  IF v_room.status = 'IN_GAME' THEN
    ...
    IF v_in_ludo_match OR v_in_r51_match OR v_in_bg_match OR v_in_ck_match OR v_in_ch_match OR v_in_dom_match OR v_in_fl_match OR v_in_fg_match OR v_in_mm_match OR v_in_cc_match THEN
