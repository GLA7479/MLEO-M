-- Wire OV2 Dominoes into shared-room economy, Quick Match allowlist, and leave/forfeit.
-- Apply after 100_ov2_dominoes_rpcs_actions.sql.
--
-- Extends 095_ov2_chess_shared_integration.sql: add ov2_dominoes to policy lists + v_in_dom_match + forfeit branch.
...
BEGIN
  ...
  IF v_room.status = 'IN_GAME' THEN
    ...
    IF v_in_ludo_match OR v_in_r51_match OR v_in_bg_match OR v_in_ck_match OR v_in_ch_match OR v_in_dom_match THEN
