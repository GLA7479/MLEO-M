-- Wire Backgammon into shared-room economy policy, Quick Match, and leave/forfeit.
-- Apply after 081_ov2_backgammon_rpcs.sql and 077_ov2_shared_pre_game_refund_qm_early_start_hard_close.sql.
...
BEGIN
  ...
  IF v_room.status = 'IN_GAME' THEN
    ...
    IF v_in_ludo_match OR v_in_r51_match OR v_in_bg_match THEN
