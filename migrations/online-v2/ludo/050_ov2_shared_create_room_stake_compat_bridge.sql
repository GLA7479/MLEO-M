-- Shared create bridge:
-- keep shared room contract unchanged while setting the real default room entry value.
-- Scope: only ov2_shared_create_room function body.
...
BEGIN
  ...
  INSERT INTO public.ov2_rooms (
    ...
    v_title,
    'lobby',
    100, -- real default minimum room entry value.
    v_host,
    v_vis = 'private',
    v_max,
    1,
