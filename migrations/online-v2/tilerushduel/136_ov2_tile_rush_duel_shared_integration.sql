-- Wire OV2 Tile Rush Duel into shared-room economy, Quick Match allowlist, max players, and leave/forfeit.
-- Apply after 135_ov2_tile_rush_duel_rpcs_actions.sql (and after any migration that last replaced ov2_shared_leave_room).
-- Extends the integration surface from 131_ov2_fleet_hunt_shared_integration.sql with Tile Rush Duel.
...
BEGIN
  ...
  IF v_room.status = 'IN_GAME' THEN
    ...
    IF v_in_ludo_match OR v_in_r51_match OR v_in_bg_match OR v_in_ck_match OR v_in_ch_match OR v_in_dom_match OR v_in_fl_match OR v_in_fg_match OR v_in_mm_match OR v_in_cc_match OR v_in_fh_match OR v_in_trd_match THEN
