...
function CoinFaceHeads() {
  return (
    <div
      ...
      aria-hidden
    >
      <span className="text-[3.25rem] font-black leading-none text-emerald-100 drop-shadow sm:text-6xl lg:text-7xl">H</span>
...
function CoinFaceTails() {
  return (
    <div
      ...
      aria-hidden
    >
      <span className="text-[3.25rem] font-black leading-none text-violet-100 drop-shadow sm:text-6xl lg:text-7xl">T</span>
