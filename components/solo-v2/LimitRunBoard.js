...
/**
 * Limit Run inner playfield only — ladder shell (notice, status, strip, payout) lives on the page.
 * Preserves limbo identity: hero × readout, result line, target slider, presets, stats grid, Roll.
 */
export default function LimitRunBoard({
  ...
  return (
    <div className="flex w-full min-h-0 flex-col overflow-hidden max-lg:flex-1 lg:shrink-0">
      ...
      <div className="relative mx-auto h-9 w-full max-w-[min(100%,420px)] shrink-0 px-0 sm:h-10 lg:max-w-none">
        <p
      ...
      <div className="flex shrink-0 flex-col lg:flex-row lg:items-stretch lg:gap-6">
        <div className="flex min-w-0 flex-none items-center justify-center px-0 py-0.5 max-h-[min(21vh,9rem)] sm:max-h-none sm:px-1 sm:py-2 lg:max-h-none lg:min-h-0 lg:flex-1 lg:py-4">
          <div
        ...
        <div className="mt-auto flex min-h-0 w-full shrink-0 flex-col border-t border-zinc-700/45 bg-zinc-950/80 px-1.5 py-2.5 sm:mt-0 sm:border-t-0 sm:bg-transparent sm:px-2 sm:py-2 lg:mt-0 lg:w-[min(100%,22rem)] lg:border-l lg:border-t-0 lg:border-zinc-700/45 lg:px-0 lg:pl-5 lg:pt-1">
          <div className="mx-auto flex w-full flex-col gap-2.5 sm:gap-2">
            ...
            <div className="grid min-h-[3.35rem] grid-cols-2 gap-2 rounded-lg border border-zinc-700/50 bg-zinc-900/80 px-2.5 py-2 text-center sm:min-h-[3.25rem] sm:gap-1.5 sm:px-2 sm:py-2">
