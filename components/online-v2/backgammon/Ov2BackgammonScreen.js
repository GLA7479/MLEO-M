...
function BoardPoint({
  ...
  const fill =
    tone === "a"
      ? "from-[#e8d4b4] via-[#e0cda8] to-[#dbc7a3]"
      : "from-[#763232] via-[#6e2f2f] to-[#4a2220]";
...
export default function Ov2BackgammonScreen({ contextInput = null, onSessionRefresh }) {
  ...
  const barCol = (
    <div
      className={`flex w-9 shrink-0 flex-col border-x border-black/32 bg-gradient-to-b from-[#061a15] via-[#051410] to-[#040d0b] shadow-[inset_0_0_10px_rgba(0,0,0,0.32)] sm:w-11 md:w-14 ${
    ...
    >
      <button
        ...
        className={`${OV2BG_BTN} flex min-h-0 flex-1 flex-col items-center justify-center gap-1 px-0.5 py-1 sm:py-1.5 ${
  ...
  const offColumn = (
    <div
      className={`flex w-10 shrink-0 flex-col border-l border-white/[0.09] bg-[#0f3228]/88 shadow-[inset_2px_0_14px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.07)] sm:w-12 md:w-[3.25rem] ${
        swapBoardHalvesForViewer ? "flex-col-reverse" : ""
      }`}
    >
      <button
        ...
        className={`${OV2BG_BTN} flex min-h-0 flex-1 flex-col items-center justify-start gap-1 border-b border-black/25 py-1 sm:py-1.5 ${
      ...
      <button
        ...
        className={`${OV2BG_BTN} flex min-h-0 flex-1 flex-col items-center justify-end gap-1 py-1 sm:py-1.5 ${
    ...
    <div className="ov2-backgammon-root ov2bg-bg-breath relative flex h-full min-h-0 flex-1 flex-col gap-0.5 overflow-hidden bg-[radial-gradient(ellipse_85%_65%_at_50%_42%,#0F1720_0%,#0B0F14_55%,#080b10_100%)] px-1 pb-0.5 pt-0 text-white before:pointer-events-none before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_70%_55%_at_50%_48%,transparent_0%,rgba(5,8,14,0.55)_100%)] sm:gap-1 sm:px-2 sm:pb-1">
      ...
      <div className="relative z-[1] flex min-h-0 min-w-0 flex-1 flex-col items-center justify-center overflow-hidden">
        <div className="ov2bg-frame-sh flex w-full max-w-full flex-col overflow-hidden rounded-lg border border-[#3d2e24]/88 bg-gradient-to-b from-[#3A2A20] via-[#2f2218] to-[#2A1F17] p-[2px] max-md:h-[min(43svh,86vw)] max-md:max-h-[44svh] max-md:flex-none sm:rounded-xl sm:p-0.5 md:h-[min(62vh,572px)] md:max-w-4xl md:p-1 lg:max-w-[52rem] lg:p-1.5 xl:max-w-[56rem]">
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-row gap-px overflow-hidden rounded-sm bg-[#0E2A22] p-px shadow-[inset_0_2px_14px_rgba(0,0,0,0.26),inset_0_0_0_1px_rgba(0,0,0,0.16)] sm:gap-1 sm:p-0.5">
