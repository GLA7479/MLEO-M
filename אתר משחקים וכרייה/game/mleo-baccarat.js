...
export default function CardDuelPage() {
  ...
  const checkResult = async (finishResult, play) => {
    ...
    const resultData = { win, playerScore: pScore, bankerScore: bScore, playType: playType.name, prizeMultiplier: Number(payload.multiplier || playType.prize), prize, profit: win ? prize - play : -play, tie: isTie };
