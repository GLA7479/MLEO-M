      ...
      >
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 pb-20 pt-16">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/70">Choose Heads or Tails • Win ×{WIN_MULTIPLIER}</p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <input
              ...
              disabled={flipping}
              className="w-32 h-12 bg-black/30 border border-white/20 rounded-lg text-center text-white font-bold disabled:opacity-50"
              min={MIN_BET}
            />
            <button
              onClick={() => {
          ...
          <div className="flex flex-col gap-3 w-full max-w-sm">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2 rounded-lg bg-blue-500/20 border border-blue-500/30 text-blue-300 hover:bg-blue-500/30 font-semibold"
              >
                How to Play
              </button>
              <button
                onClick={() => { setShowStats(true); playSfx(clickSound.current); }}
                className="flex-1 py-2 rounded-lg bg-purple-500/20 border border-purple-500/30 text-purple-300 hover:bg-purple-500/30 font-semibold"
              >
                Stats
              </button>
            </div>
