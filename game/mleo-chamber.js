...
export default function ChamberPage() {
  ...
  const currentPrize = selectedChambers.length > 0 ? Math.floor(Number(playAmount) * Math.pow(1.5, selectedChambers.length)) : 0;
