              ...
              <div className="absolute inset-x-6 top-[88px] bottom-[106px]">
                <div className="mx-auto h-full max-w-6xl rounded-[30px] border border-white/10 bg-[#0b1526] shadow-2xl">
                  <button
                    ...
                    className="group flex w-full items-center justify-between gap-3 border-b border-white/10 px-5 py-4 text-left outline-none transition hover:bg-white/[0.04] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-cyan-400/45 focus-visible:ring-offset-0"
                  >
                    ...
                    <div className="flex shrink-0 items-center gap-3 pointer-events-none">
                      <WindowBankedBadge value={bankedDisplayValue} />
                      <span
                        aria-hidden
                        className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-bold text-white/90 group-hover:border-white/12 group-hover:bg-white/[0.09]"
                      >
                        Close
                      </span>
                    </div>
