      ...
      >
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 pb-16 pt-14 overflow-y-auto" style={{ minHeight: '100%' }}>
          ...
          <div className="text-center mb-3">
            ...
            <p className="text-white/70 text-sm">Ancient Chinese dice • Multiple betting options!</p>
          </div>
          ...
          {/* Bet Type Selection */}
          <div className="grid grid-cols-2 gap-2 mb-3 w-full max-w-md" style={{ minHeight: '120px' }}>
