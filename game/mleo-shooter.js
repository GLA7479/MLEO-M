...
export default function ShooterPage() {
  ...
  return (
    <Layout>
      <div ref={wrapRef} className="relative w-full overflow-hidden bg-gradient-to-br from-blue-900 via-black to-cyan-900" style={{ height: 'var(--app-100vh, 100vh)' }}>
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 pb-16 pt-14 overflow-y-auto" style={{ minHeight: '100%' }}>
          <div className="text-center mb-3"><h1 className="text-3xl md:text-4xl font-extrabold text-white mb-1">🎯 Target Shooter</h1><p className="text-white/70 text-sm">Hit {TOTAL_TARGETS} targets in {TIME_LIMIT} seconds!</p></div>
          ...
          <div className="mb-3 w-full max-w-md relative bg-black/20 border border-white/10 rounded-lg" style={{ minHeight: '220px', height: '220px' }}>
