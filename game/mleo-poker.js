...
const PRIZES = { "Royal Flush": 1000, "Straight Flush": 200, "Four of a Kind": 50, "Full Platform": 20, "Flush": 10, "Straight": 8, "Three of a Kind": 5, "Two Pair": 3, "One Pair": 2, "High Card": 0 };
...
export default function PokerPage() {
  ...
  const potentialWin = Math.floor(Number(playAmount) * 1000);
